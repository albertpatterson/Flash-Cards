...
const insertRecentsUrlPrefix =
    'https://us-central1-flashcards-6c206.cloudfunctions.net/app/recents?item=';
function insertRecent(spreadsheet) {
  return new Promise(
      (res, rej) => {firebase.auth().currentUser.getIdToken().then(id_token => {
